...
namespace ClientLibrary.Helpers
{
    public class CustomHttpHandler(GetHttpClient getHttpClient,
        LocalStorageService localStorageService, IUserAccountService accountService) : DelegatingHandler
    {
        ...
        private async Task<string> GetRefreshToken(string refreshToken)
        {
            ...
            string serializedToken = Serialization.SerializeObj(new UserSession() { Token = result.Token, RefreshToken = result.RefreshToken });
